...
const Feedback = () => {
  ...
  return (
    <div className='bg-[#007882] dark:bg-white mt-8'>
      <div className='container mx-auto py-10 text-center text-white dark:text-black w-[60%]' >
        <Slider {...settings} className={style}>
            {listData.map((data, index) => {
                return (
                    <div  key={index}>
        <h1 className='text-[25px] font-bold'>Lem apartment</h1>
        <p className='mt-2'>Moved to VietNam in June 2022</p>
        <h4 className='my-3 w-[50%] mx-auto'>
