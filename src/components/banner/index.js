...
import ImgBanner from '../../assets/img/img-9.jpg';
  ...
  return (
    <div className="mt-[7px] container mx-auto relative">
      <div className='relative'>
        <img src={ImgBanner} alt='img-banner' className='border rounded-3xl w-full h-[700px] object-fill mt' />
      </div>

      <div className='absolute text-center top-[8%] left-[25%] z-10 w-[49.3%]'>
        <p className='text-[55px] font-extrabold mb-4 text-[#007882]'>LET'S STAY LET'S ENJOY</p>
        ...
        <p className='text-[55px] font-medium mt-5 text-[#007882]'>FIND YOUR APARTMENT FOR VACATION IN DA NANG</p>
      </div>
    </div>
  )
}
