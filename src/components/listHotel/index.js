...
const ListHotel = () => {
  ...
  const { isMobile, isTablet, isPcSD } = useDevice();

  const settings = {
    dots: true,
    infinite: true,
    slidesToShow: isMobile ? 1 : isTablet ? 2 : isPcSD ? 3 : 4,
    slidesToScroll: 1,
    autoplay: false,
    autoplaySpeed: 2000,
    speed: 500,
  ...
  return (
    <div className='container mx-auto mt-8'>
      <div className='text-center'>
        <p className=' text-[24px]  md:text-[35px] lg:text-[55px] font-medium w-[70%] md:w-[100%] lg:w-[100%] mx-auto'>Explore some feature our listings in Da Nang</p>
        <p className=' text-[18px] md:text-[20px] lg:text-[25px] text-[#727171]'>Here are trust listing reviewed by tourists</p>
      </div>

      <Slider {...settings} className={style}>
        {listData.map((data, index) => {
          return (
            <Link to={'/detail-listing'} key={index}>
              <div className='mt-5'>
                <div className='relative w-[350px] '>
                  ...
                  <p className='text-base	text-[#727171] dark:text-black line-clamp-2'>Luxury apartment for vacation near beach and mountain, easy to reach airport have air-condition</p>
                  <div className='flex justify-between'>
                    <div className='flex  gap-3'>
                      <div className=' flex items-center gap-1 '>
                        <p className='text-xl font-bold text-[#727171] dark:text-black'>1</p>
                    ...
                    <div className=' flex items-center justify-end gap-1  dark:text-black'>
                  ...
                  <div>
                    <p className='text-lg text-[#727171] dark:text-black'>$<span className='font-bold'>300</span>/night</p>
                  </div>
                </div>
              </div>
            </Link>
      ...
      <div className='flex justify-center'>
        <button className='mt-20  text-center p-2 cursor-pointer border rounded-lg border-black dark:border-white shadow-xl'>
